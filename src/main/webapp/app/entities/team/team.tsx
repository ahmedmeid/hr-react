  ...
  return (
    <div>
      <h2 id="team-heading" data-cy="TeamHeading">
        <Translate contentKey="hrApp.team.home.title">Teams</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> <Translate contentKey="hrApp.team.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/team/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hrApp.team.home.createLabel">Create new Team</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teamList && teamList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hrApp.team.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="hrApp.team.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hrApp.team.home.notFound">No Teams found</Translate>
            </div>
          )
        )}
      </div>
